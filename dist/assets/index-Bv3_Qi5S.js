(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))i(n);new MutationObserver(n=>{for(const s of n)if(s.type==="childList")for(const r of s.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&i(r)}).observe(document,{childList:!0,subtree:!0});function t(n){const s={};return n.integrity&&(s.integrity=n.integrity),n.referrerPolicy&&(s.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?s.credentials="include":n.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(n){if(n.ep)return;n.ep=!0;const s=t(n);fetch(n.href,s)}})();class de{constructor(e){this.containerId=e,this._tileCount=0,this._fpsFrames=0,this._fpsLastTime=performance.now(),this._fpsInterval=null,this._onTileCountChange=null,this._onFPSUpdate=null,this._initViewer(),this._setupFPSCounter()}_initViewer(){Cesium.Ion.defaultAccessToken="",this.viewer=new Cesium.Viewer(this.containerId,{animation:!1,timeline:!1,baseLayerPicker:!1,geocoder:!1,homeButton:!1,sceneModePicker:!1,navigationHelpButton:!1,fullscreenButton:!1,infoBox:!1,selectionIndicator:!1,shouldAnimate:!0,imageryProvider:new Cesium.UrlTemplateImageryProvider({url:"https://webst0{s}.is.autonavi.com/appmaptile?style=6&x={x}&y={y}&z={z}",subdomains:["1","2","3","4"],maximumLevel:18,credit:""}),terrain:void 0}),this.viewer.scene.globe.enableLighting=!1,this.viewer.scene.skyAtmosphere.show=!1,this.viewer.scene.fog.enabled=!1,this.viewer.scene.backgroundColor=Cesium.Color.fromCssColorString("#0a0e14"),this.viewer.scene.globe.showGroundAtmosphere=!1,this.viewer.scene.synchronicBlockedFrames=0,this.viewer.clock.shouldAnimate=!0,this.viewer.scene.postProcessStages.fxaa.enabled=!0;const e=this.viewer.scene.canvas;e.style.pointerEvents="auto",e.style.cursor="grab",this._originalCursor=e.style.cursor,this.viewer.camera.setView({destination:Cesium.Cartesian3.fromDegrees(116.391,39.907,500)}),this._setupInputHandlers()}_setupInputHandlers(){const e=this.viewer.screenSpaceEventHandler,t=[Cesium.ScreenSpaceEventType.LEFT_DOWN,Cesium.ScreenSpaceEventType.LEFT_UP,Cesium.ScreenSpaceEventType.RIGHT_DOWN,Cesium.ScreenSpaceEventType.RIGHT_UP,Cesium.ScreenSpaceEventType.MIDDLE_DOWN,Cesium.ScreenSpaceEventType.MIDDLE_UP,Cesium.ScreenSpaceEventType.MOUSE_MOVE,Cesium.ScreenSpaceEventType.WHEEL,Cesium.ScreenSpaceEventType.PINCH_START,Cesium.ScreenSpaceEventType.PINCH_MOVE,Cesium.ScreenSpaceEventType.PINCH_END];for(const i of t)e.removeInputAction(i)}_setupFPSCounter(){this._fpsInterval=setInterval(()=>{const e=performance.now(),t=e-this._fpsLastTime,i=this._fpsFrames/t*1e3;this._fpsFrames=0,this._fpsLastTime=e,this._onFPSUpdate&&this._onFPSUpdate(i)},1e3),this.viewer.scene.postRender.addEventListener(()=>{this._fpsFrames++})}getCanvas(){return this.viewer.scene.canvas}getWidth(){return this.viewer.scene.canvas.width}getHeight(){return this.viewer.scene.canvas.height}getScene(){return this.viewer.scene}getCameraMatrix(){const e=this.viewer.camera;return{view:e.viewMatrix.clone(),projection:e.frustum.projectionMatrix.clone(),inverseView:e.inverseViewMatrix.clone(),position:e.position.clone(),direction:e.direction.clone(),up:e.up.clone(),right:e.right.clone()}}screenshot(){const e=this.viewer.scene.canvas,t=document.createElement("canvas");return t.width=e.width,t.height=e.height,t.getContext("2d").drawImage(e,0,0),t}flyHome(){this.viewer.camera.flyHome(1.5)}flyToEntity(e){if(!e||!e.boundingBox)return;const t=e.boundingBox.center,i=e.boundingBox;Cesium.Cartesian3.fromDegrees(t[0],t[1],t[2]);const s=Math.max(i.max[0]-i.min[0],i.max[1]-i.min[1],i.max[2]-i.min[2])*3;this.viewer.camera.flyTo({destination:Cesium.Cartesian3.fromDegrees(t[0],t[1]-.001,t[2]+s),duration:1.5})}setViewByDirection(e,t){const i=this.viewer.camera;let n,s;switch(e){case"top":n=new Cesium.Cartesian3(0,0,-1),s=new Cesium.Cartesian3(0,1,0);break;case"angle":n=new Cesium.Cartesian3(-1,-1,-1),s=new Cesium.Cartesian3(0,0,1);break;case"front":n=new Cesium.Cartesian3(0,-1,0),s=new Cesium.Cartesian3(0,0,1);break;default:n=new Cesium.Cartesian3(0,-1,0),s=new Cesium.Cartesian3(0,0,1)}if(t){const r=Cesium.Cartographic.fromCartesian(t),o=Math.max(500,r.height+300),h=Cesium.Cartesian3.add(t,Cesium.Cartesian3.multiplyByScalar(n,o),new Cesium.Cartesian3);i.setView({destination:h,orientation:{direction:n,up:s}})}else{const r=e==="top"?new Cesium.Cartesian3(0,0,0):i.position.clone();i.lookAt(r,new Cesium.HeadingPitchRange(0,Cesium.Math.toRadians(-45),0)),i.setView({orientation:{direction:n,up:s}})}}pickScreenPosition(e,t){return this.viewer.camera.pickEllipsoid(new Cesium.Cartesian2(e,t),this.viewer.scene.globe.ellipsoid)}screenToCartesian(e,t){const i=this.viewer.camera.getPickRay(new Cesium.Cartesian2(e,t));return i?this.viewer.scene.globe.pick(i,this.viewer.scene.globe.ellipsoid):null}getVisibleBounds(){const t=this.viewer.camera.computeViewRectangle();return t?{west:t.west,east:t.east,south:t.south,north:t.north}:null}getCameraFrustum(){return this.viewer.camera.frustum}onTileCountChange(e){this._onTileCountChange=e}onFPSUpdate(e){this._onFPSUpdate=e}updateTileCount(e){this._tileCount=e,this._onTileCountChange&&this._onTileCountChange(e)}setCursor(e){this.viewer.scene.canvas.style.cursor=e}destroy(){this._fpsInterval&&(clearInterval(this._fpsInterval),this._fpsInterval=null),this.viewer&&(this.viewer.destroy(),this.viewer=null)}}class me{constructor(e){this.viewer=e,this.tileset=null,this._currentTriangles=[],this._tileLoadProgress=0,this._onTilesReady=null}async load(e){var t;this.clear(),P("正在获取瓦片配置..."),ge("加载瓦片数据...");try{const i=await fetch(e);if(!i.ok)throw new Error("HTTP "+i.status+" "+i.statusText);const n=await i.json();return console.log("Tileset JSON loaded:",(t=n.asset)==null?void 0:t.version,"root:",!!n.root),P("正在初始化三维瓦片..."),new Promise((s,r)=>{try{const o=new Cesium.Cesium3DTileset({url:e,maximumScreenSpaceError:16,skipLevelOfDetail:!0,baseScreenSpaceError:1024});if(this.tileset=o,o.initialTilesLoaded.addEventListener(()=>{P("瓦片基础层级加载完成"),K()}),o.allTilesLoaded.addEventListener(()=>{console.log("All tiles loaded"),P("所有瓦片加载完成")}),o.tileFailed.addEventListener(a=>{console.warn("Tile failed:",a)}),this.viewer.viewer.scene.primitives.add(o),o.boundingSphere){const a=Math.max(o.boundingSphere.radius,100);this.viewer.viewer.camera.flyToBoundingSphere(o.boundingSphere,{duration:2,offset:new Cesium.HeadingPitchRange(0,Cesium.Math.toRadians(-30),a*2)})}let h=0;const c=()=>{if(this.tileset&&!this.tileset.isDestroyed()){h++;const a=this._countTiles(this.tileset);this.viewer.updateTileCount(a),h%30===0&&this._extractTriangleData(this.tileset)}requestAnimationFrame(c)};c(),setTimeout(()=>{this._extractTriangleData(this.tileset),s(o)},5e3),setTimeout(()=>{s(o)},15e3)}catch(o){r(o)}})}catch(i){throw console.error("Tile load failed:",i),K(),P("瓦片加载失败: "+i.message),i}}_countTiles(e){let t=0;const i=n=>{if(n&&(t++,n._children))for(const s of n._children)s&&i(s)};return e._root&&i(e._root),t}_extractTriangleData(e){if(!e._root||this._extracting)return;this._extracting=!0;const t=[],i=n=>{if(!(!n||!n.content)){try{const s=n.content._content||n.content;if(!s)return;const r=s._primitive||s;if(!r||!r.geometry)return;const o=r.geometry.getAttribute("position"),h=r.geometry.getIndex();if(!o||!h)return;const c=o.array,a=h.array,d=n._boundingVolumeCenter?Cesium.Matrix4.fromTranslation(n._boundingVolumeCenter):null;for(let m=0;m<a.length;m+=3){const g=a[m]*3,f=a[m+1]*3,w=a[m+2]*3;if(g+2>=c.length)continue;const p=new Cesium.Cartesian3(c[g],c[g+1],c[g+2]),v=new Cesium.Cartesian3(c[f],c[f+1],c[f+2]),M=new Cesium.Cartesian3(c[w],c[w+1],c[w+2]),_=d?Cesium.Matrix4.multiplyByPoint(d,p,new Cesium.Cartesian3):p,b=d?Cesium.Matrix4.multiplyByPoint(d,v,new Cesium.Cartesian3):v,T=d?Cesium.Matrix4.multiplyByPoint(d,M,new Cesium.Cartesian3):M;t.push({vertices:[_,b,T],tileId:n._id||"unknown",center:new Cesium.Cartesian3((_.x+b.x+T.x)/3,(_.y+b.y+T.y)/3,(_.z+b.z+T.z)/3)})}}catch{}if(n._children)for(const s of n._children)s&&i(s)}};i(e._root),this._currentTriangles=t,this._extracting=!1}getCurrentTiles(){return this._currentTriangles||[]}getVisibleTriangles(){return this._currentTriangles||[]}clear(){this.tileset&&(this.viewer.viewer.scene.primitives.remove(this.tileset),this.tileset=null),this._currentTriangles=[]}isLoaded(){return this.tileset!==null}getBoundingSphere(){return this.tileset&&this.tileset.boundingSphere?this.tileset.boundingSphere:null}}function P(l){const e=document.getElementById("statusText");e&&(e.textContent=l)}function ge(l){const e=document.getElementById("loadingOverlay"),t=document.getElementById("loadingText");e&&t&&(e.style.display="block",t.textContent=l)}function K(){const l=document.getElementById("loadingOverlay");l&&(l.style.display="none")}class fe{constructor(e){this.viewer=e,this._originalCameraState=null}getView(e){const t={top:{label:"俯视",dir:"top"},angle:{label:"斜45°",dir:"angle"},front:{label:"平视",dir:"front"}};return t[e]||t.angle}getViewWithRect(e,t){return{...this.getView(e),rect:t}}async renderViews(e){this._saveOriginalCamera();const t=[];for(const i of e)try{const n=await this._renderSingleView(i);t.push(n)}catch(n){console.error("Failed to render view:",i.dir,n);const s=this.viewer.getCanvas();t.push({viewType:i.label,viewDir:i.dir,image:this._createBlankCanvas(s.width,s.height),depthMap:null,pixelMapping:new Int32Array(s.width*s.height).fill(-1),cameraMatrix:this.viewer.getCameraMatrix(),width:s.width,height:s.height,rect:i.rect||null})}return this._restoreOriginalCamera(),t}_saveOriginalCamera(){const e=this.viewer.viewer.camera;this._originalCameraState={position:e.position.clone(),direction:e.direction.clone(),up:e.up.clone(),right:e.right.clone()}}_restoreOriginalCamera(){this._originalCameraState&&(this.viewer.viewer.camera.setView({destination:this._originalCameraState.position,orientation:{direction:this._originalCameraState.direction,up:this._originalCameraState.up}}),this._originalCameraState=null)}async _renderSingleView(e){const t=this.viewer.getCanvas(),i=t.width,n=t.height,s=this.viewer.viewer.camera;this._setCameraForView(s,e),await this._waitForRender(5);const r=this.viewer.screenshot(),o=this._captureDepthMap(),h=this._buildPixelTriangleMapping(s,i,n),c=this.viewer.getCameraMatrix();return{viewType:e.label,viewDir:e.dir,image:r,depthMap:o,pixelMapping:h,cameraMatrix:c,width:i,height:n,rect:e.rect||null}}_setCameraForView(e,t){const i=this._getSceneCenter(),n=Cesium.Cartesian3.fromDegrees(i.lon,i.lat,i.height);switch(t.dir){case"top":{e.setView({destination:Cesium.Cartesian3.fromDegrees(i.lon,i.lat,500),orientation:{direction:new Cesium.Cartesian3(0,0,-1),up:new Cesium.Cartesian3(0,1,0)}});break}case"angle":{const r=Cesium.Cartesian3.fromDegrees(i.lon-.003,i.lat-.003,i.height+600),o=Cesium.Cartesian3.subtract(n,r,new Cesium.Cartesian3);Cesium.Cartesian3.normalize(o,o),e.setView({destination:r,orientation:{direction:o,up:new Cesium.Cartesian3(0,0,1)}});break}case"front":{const s=Cesium.Cartesian3.fromDegrees(i.lon,i.lat-.005,i.height+100),r=Cesium.Cartesian3.subtract(n,s,new Cesium.Cartesian3);Cesium.Cartesian3.normalize(r,r),e.setView({destination:s,orientation:{direction:r,up:new Cesium.Cartesian3(0,0,1)}});break}}}_getSceneCenter(){const t=this.viewer.getScene().primitives;for(let s=0;s<t.length;s++){const r=t.get(s);if(r&&r.boundingSphere){const o=r.boundingSphere.center,h=Cesium.Cartographic.fromCartesian(o);return{lon:Cesium.Math.toDegrees(h.longitude),lat:Cesium.Math.toDegrees(h.latitude),height:h.height}}}const i=this.viewer.viewer.camera,n=Cesium.Cartographic.fromCartesian(i.position);return{lon:Cesium.Math.toDegrees(n.longitude),lat:Cesium.Math.toDegrees(n.latitude),height:n.height}}_waitForRender(e){return new Promise(t=>{let i=0;const n=()=>{i++,i>=e?t():requestAnimationFrame(n)};requestAnimationFrame(n)})}_captureDepthMap(){const e=this.viewer.getScene(),t=e.depthTexture;if(!t)return null;try{const n=e.context.gl,s=t.width,r=t.height,o=n.createFramebuffer();n.bindFramebuffer(n.FRAMEBUFFER,o),n.framebufferTexture2D(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,t,0);const h=new Float32Array(s*r*4);n.readPixels(0,0,s,r,n.RGBA,n.FLOAT,h),n.bindFramebuffer(n.FRAMEBUFFER,null),n.deleteFramebuffer(o);const c=new Float32Array(s*r);for(let a=0;a<s*r;a++)c[a]=h[a*4];return{data:c,width:s,height:r}}catch{return null}}_buildPixelTriangleMapping(e,t,i){const n=new Int32Array(t*i).fill(-1),r=this.viewer.getScene().primitives;let o=null;for(let p=0;p<r.length;p++){const v=r.get(p);if(v&&v._root){o=v;break}}if(!o||!o._root)return n;const h=e.frustum,c=e.direction,a=e.right,d=e.up,m=e.position,g=h.fov,f=t/i,w=(p,v)=>{if(!p||!p.content)return 0;let M=0;try{const _=p.content._content||p.content;if(!_)return 0;const b=_._primitive||_;if(!b||!b.geometry)return 0;const T=b.geometry.getAttribute("position"),J=b.geometry.getIndex();if(!T||!J)return 0;const x=T.array,L=J.array,S=p._boundingVolumeCenter?Cesium.Matrix4.fromTranslation(p._boundingVolumeCenter):null;for(let k=0;k<L.length;k+=3){const B=L[k]*3,R=L[k+1]*3,F=L[k+2]*3;if(B+2>=x.length||R+2>=x.length||F+2>=x.length)continue;const q=new Cesium.Cartesian3(x[B],x[B+1],x[B+2]),X=new Cesium.Cartesian3(x[R],x[R+1],x[R+2]),Y=new Cesium.Cartesian3(x[F],x[F+1],x[F+2]),D=S?Cesium.Matrix4.multiplyByPoint(S,q,new Cesium.Cartesian3):q,z=S?Cesium.Matrix4.multiplyByPoint(S,X,new Cesium.Cartesian3):X,V=S?Cesium.Matrix4.multiplyByPoint(S,Y,new Cesium.Cartesian3):Y,ee=Cesium.Cartesian3.subtract(D,m,new Cesium.Cartesian3),te=Cesium.Cartesian3.subtract(z,m,new Cesium.Cartesian3),ie=Cesium.Cartesian3.subtract(V,m,new Cesium.Cartesian3),A=Cesium.Cartesian3.dot(ee,c),H=Cesium.Cartesian3.dot(te,c),O=Cesium.Cartesian3.dot(ie,c);if(A<0&&H<0&&O<0)continue;const ne=Math.max(A,H,O),se=Math.min(A,H,O);if(ne<0||se>1e4)continue;const re=new Cesium.Cartesian3((D.x+z.x+V.x)/3,(D.y+z.y+V.y)/3,(D.z+z.z+V.z)/3),U=Cesium.Cartesian3.subtract(re,m,new Cesium.Cartesian3),G=Cesium.Cartesian3.dot(U,c);if(G<=0)continue;const oe=Cesium.Cartesian3.dot(U,a),ae=Cesium.Cartesian3.dot(U,d),Z=Math.tan(g/2),ce=Z*f,le=(oe/(G*ce)+1)/2,he=1-(ae/(G*Z)+1)/2,N=Math.floor(le*t),j=Math.floor(he*i);if(N>=0&&N<t&&j>=0&&j<i){const ue=j*t+N;n[ue]=v+M}M++}}catch{}if(p._children&&p._children.length>0)for(const _ of p._children)_&&(M+=w(_,v+M));return M};return o._root&&w(o._root,0),n}_createBlankCanvas(e,t){const i=document.createElement("canvas");i.width=e,i.height=t;const n=i.getContext("2d");return n.fillStyle="#0a0e14",n.fillRect(0,0,e,t),i}}class Ce{constructor(){this._worker=null,this._ready=!1,this._init()}_init(){const e=this._getWorkerCode(),t=new Blob([e],{type:"application/javascript"}),i=URL.createObjectURL(t);this._worker=new Worker(i),this._workerUrl=i}_getWorkerCode(){return`
    ...
    `}async init(){return new Promise(e=>{if(this._ready){e(!0);return}const t=i=>{const n=i.data;n.type==="ready"?(this._ready=n.data.success,this._worker.removeEventListener("message",t),e(n.data.success)):n.type==="error"&&(this._worker.removeEventListener("message",t),e(!1))};this._worker.addEventListener("message",t),this._worker.postMessage({type:"init"})})}async segmentMultiView(e){this._ready||await this.init();const t=[];for(const i of e){const n=await this._segmentSingleView(i);t.push({viewType:i.viewType,viewDir:i.viewDir,mask:n.data,width:n.width,height:n.height,pixelMapping:i.pixelMapping,cameraMatrix:i.cameraMatrix,rect:i.rect})}return t}async _segmentSingleView(e){const{image:t,width:i,height:n,viewType:s,rect:r}=e;let o=i,h=n,c;if(r){const a=Math.max(0,Math.floor(r.x)),d=Math.max(0,Math.floor(r.y)),m=Math.min(i-a,Math.floor(r.width)),g=Math.min(n-d,Math.floor(r.height)),f=document.createElement("canvas");f.width=m,f.height=g;const w=f.getContext("2d");w.drawImage(t,a,d,m,g,0,0,m,g),c=w.getImageData(0,0,m,g),o=m,h=g}else{const a=document.createElement("canvas");a.width=i,a.height=n;const d=a.getContext("2d");d.drawImage(t,0,0),c=d.getImageData(0,0,i,n)}return new Promise(a=>{const d=m=>{const g=m.data;g.type==="result"?(this._worker.removeEventListener("message",d),a({data:g.data.mask,width:g.data.width,height:g.data.height})):g.type==="error"&&(this._worker.removeEventListener("message",d),a({data:new Uint8Array(o*h),width:o,height:h}))};this._worker.addEventListener("message",d),this._worker.postMessage({type:"segment",imageData:{width:c.width,height:c.height,data:c.data},viewType:s})})}clear(){}destroy(){this._worker&&(this._worker.terminate(),this._worker=null),this._workerUrl&&(URL.revokeObjectURL(this._workerUrl),this._workerUrl=null),this._ready=!1}}class we{constructor(e){this.viewer=e,this._pixelTriangleMap=null}projectTo3D(e,t,i){const n=new Map;for(let s=0;s<t.length;s++){const r=t[s],o=e[s],h=this._projectViewMask(r,o,i);this._mergeTriangleSets(n,h)}return Array.from(n.values())}_projectViewMask(e,t,i){const{mask:n,width:s,height:r,pixelMapping:o,cameraMatrix:h}=e,c=new Map,a=e.width,d=e.height;for(let m=0;m<d;m++)for(let g=0;g<a;g++)if(n[m*a+g]===1){let f=g,w=m;(a!==s||d!==r)&&(f=Math.floor(g*s/a),w=Math.floor(m*r/d));const p=w*s+f,v=o[p];v>=0&&v<i.length&&c.set(v,i[v])}return c}_mergeTriangleSets(e,t){for(const[i,n]of t)e.has(i)||e.set(i,n)}fuseMultiViewMasks(e){if(!e||e.length===0)return null;if(e.length===1)return e[0];const t=e[0],i=new Uint8Array(t.width*t.height);for(const n of e)if(n.width===t.width&&n.height===t.height)for(let s=0;s<i.length;s++)n.mask[s]===1&&(i[s]=1);else{const s=t.width/n.width,r=t.height/n.height;for(let o=0;o<n.height;o++)for(let h=0;h<n.width;h++)if(n.mask[o*n.width+h]===1){const c=Math.floor(h*s),a=Math.floor(o*r);c>=0&&c<t.width&&a>=0&&a<t.height&&(i[a*t.width+c]=1)}}return{data:i,width:t.width,height:t.height}}pixelsToWorld(e,t){const{view:i,projection:n,position:s,direction:r,up:o,right:h}=t,c=[];for(const a of e){const d=a.depth||100,m=a.x/a.width*2-1,g=1-a.y/a.height*2,f=new Cesium.Cartesian4(m,g,-1,1),w=Cesium.Matrix4.multiplyByPoint(Cesium.Matrix4.inverse(n,new Cesium.Matrix4),f,new Cesium.Cartesian4);w.x/=w.w,w.y/=w.w,w.z/=w.w;const p=new Cesium.Cartesian3(s.x+r.x*d+h.x*w.x+o.x*w.y,s.y+r.y*d+h.y*w.x+o.y*w.y,s.z+r.z*d+h.z*w.x+o.z*w.y);c.push(p)}return c}computeTriangleCenters(e){return e.map(t=>{const i=t.vertices[0],n=t.vertices[1],s=t.vertices[2];return new Cesium.Cartesian3((i.x+n.x+s.x)/3,(i.y+n.y+s.y)/3,(i.z+n.z+s.z)/3)})}}class pe{constructor(){this._connectedThreshold=.5,this._minFaces=20,this._filterGround=!0,this._groundThreshold=.1}cluster(e,t){if(this._connectedThreshold=t.connectThreshold||.5,this._minFaces=t.minFaces||20,this._filterGround=t.filterGround!==void 0?t.filterGround:!0,this._groundThreshold=t.groundThreshold||.1,!e||e.length===0)return[];const i=this._preprocess(e),n=this._filterGroundTriangles(i),s=this._connectedComponentAnalysis(n);return this._buildEntities(s)}_preprocess(e){return e.map((t,i)=>{const n=t.vertices,s=n[0],r=n[1],o=n[2],h=new Cesium.Cartesian3((s.x+r.x+o.x)/3,(s.y+r.y+o.y)/3,(s.z+r.z+o.z)/3),c=[{v0:0,v1:1,length:Cesium.Cartesian3.distance(s,r)},{v0:1,v1:2,length:Cesium.Cartesian3.distance(r,o)},{v0:2,v1:0,length:Cesium.Cartesian3.distance(o,s)}],a=Math.max(c[0].length,c[1].length,c[2].length),d=this._computeNormal(s,r,o);return{id:i,vertices:[s,r,o],center:h,normal:d,maxEdge:a,area:this._computeArea(s,r,o),tileId:t.tileId||"unknown"}})}_computeNormal(e,t,i){const n=Cesium.Cartesian3.subtract(t,e,new Cesium.Cartesian3),s=Cesium.Cartesian3.subtract(i,e,new Cesium.Cartesian3),r=Cesium.Cartesian3.cross(n,s,new Cesium.Cartesian3),o=Cesium.Cartesian3.magnitude(r);return o>0?Cesium.Cartesian3.divideByScalar(r,o,new Cesium.Cartesian3):new Cesium.Cartesian3(0,0,1)}_computeArea(e,t,i){const n=Cesium.Cartesian3.subtract(t,e,new Cesium.Cartesian3),s=Cesium.Cartesian3.subtract(i,e,new Cesium.Cartesian3),r=Cesium.Cartesian3.cross(n,s,new Cesium.Cartesian3);return Cesium.Cartesian3.magnitude(r)/2}_filterGroundTriangles(e){if(!this._filterGround)return e;const t=new Map;for(const n of e)t.has(n.tileId)||t.set(n.tileId,[]),t.get(n.tileId).push(n);const i=new Set;for(const[n,s]of t){if(s.length<3)continue;let r=0;for(const h of s)r+=h.center.z;r/=s.length;let o=0;for(const h of s)o+=(h.center.z-r)**2;o=Math.sqrt(o/s.length),o<this._groundThreshold*10&&s.length>50&&i.add(n)}return e.filter(n=>!i.has(n.tileId))}_connectedComponentAnalysis(e){if(e.length===0)return[];const t=e.length,i=new Int32Array(t),n=new Int32Array(t);for(let a=0;a<t;a++)i[a]=a;const s=a=>(i[a]!==a&&(i[a]=s(i[a])),i[a]),r=(a,d)=>{const m=s(a),g=s(d);m!==g&&(n[m]<n[g]?i[m]=g:n[m]>n[g]?i[g]=m:(i[g]=m,n[m]++))},o=this._connectedThreshold;for(let a=0;a<t;a++)for(let d=a+1;d<t;d++)this._areConnected(e[a],e[d],o)&&r(a,d);const h=new Map;for(let a=0;a<t;a++){const d=s(a);h.has(d)||h.set(d,[]),h.get(d).push(a)}const c=[];for(const[a,d]of h)d.length>=this._minFaces&&c.push(d.map(m=>e[m]));return c}_areConnected(e,t,i){const n=Cesium.Cartesian3.distance(e.center,t.center);if(n<5)return!0;const s=Math.max(e.maxEdge,t.maxEdge)+i;for(let r=0;r<3;r++)for(let o=0;o<3;o++)if(Cesium.Cartesian3.distance(e.vertices[r],t.vertices[o])<i)return!0;return n<s&&Math.abs(Cesium.Cartesian3.dot(e.normal,t.normal))>.95}_buildEntities(e){const t=[];for(const i of e){const n=this._computeBoundingBox(i),s={id:t.length,faces:i,boundingBox:n,area:this._computeTotalArea(i),center:n.center,vertices:this._collectVertices(i),tileIds:[...new Set(i.map(r=>r.tileId))]};t.push(s)}return t.sort((i,n)=>n.area-i.area),t}_computeBoundingBox(e){let t=1/0,i=1/0,n=1/0,s=-1/0,r=-1/0,o=-1/0;for(const g of e)for(const f of g.vertices)f.x<t&&(t=f.x),f.x>s&&(s=f.x),f.y<i&&(i=f.y),f.y>r&&(r=f.y),f.z<n&&(n=f.z),f.z>o&&(o=f.z);const h=new Cesium.Cartesian3((t+s)/2,(i+r)/2,(n+o)/2),c=Cesium.Cartographic.fromCartesian(h),a=[Cesium.Math.toDegrees(c.longitude),Cesium.Math.toDegrees(c.latitude),c.height],d=Cesium.Cartographic.fromCartesian(new Cesium.Cartesian3(t,i,n)),m=Cesium.Cartographic.fromCartesian(new Cesium.Cartesian3(s,r,o));return{min:[Cesium.Math.toDegrees(d.longitude),Cesium.Math.toDegrees(d.latitude),d.height],max:[Cesium.Math.toDegrees(m.longitude),Cesium.Math.toDegrees(m.latitude),m.height],center:a,size:[s-t,r-i,o-n]}}_computeTotalArea(e){let t=0;for(const i of e)t+=i.area;return t}_collectVertices(e){const t=[],i=new Set;for(const n of e)for(const s of n.vertices){const r=`${s.x.toFixed(6)}_${s.y.toFixed(6)}_${s.z.toFixed(6)}`;i.has(r)||(i.add(r),t.push(s))}return t}}class ye{constructor(e){this.viewer=e,this._entityPrimitives=[],this._boundingBoxPrimitives=[],this._highlightedIndex=-1,this._entities=[],this._palette=[[.95,.3,.3],[.3,.95,.3],[.3,.3,.95],[.95,.95,.3],[.95,.3,.95],[.3,.95,.95],[.95,.6,.2],[.6,.95,.6],[.6,.6,.95],[.95,.7,.7]]}visualize(e){this.clear(),this._entities=e,this.viewer.getScene();for(let t=0;t<e.length;t++){const i=e[t],n=this._palette[t%this._palette.length];this._addEntityMesh(i,n,t===this._highlightedIndex),this._addBoundingBox(i.boundingBox,n)}}_addEntityMesh(e,t,i){const n=this.viewer.getScene(),s=[],r=[],o=[];let h=0;const c=i?[1,1,0]:t,a=i?.9:.6;for(const w of e.faces){for(let p=0;p<3;p++){const v=w.vertices[p];s.push(v.x,v.y,v.z),r.push(c[0],c[1],c[2],a)}o.push(h,h+1,h+2),h+=3}const d=new Cesium.Geometry({attributes:{position:new Cesium.GeometryAttribute({componentDatatype:Cesium.ComponentDatatype.DOUBLE,componentsPerAttribute:3,values:new Float64Array(s)}),color:Cesium.ColorGeometryInstanceAttribute.fromColor(new Cesium.Color(c[0],c[1],c[2],a))},indices:new Uint32Array(o),primitiveType:Cesium.PrimitiveType.TRIANGLES,boundingSphere:e.boundingBox}),m=Cesium.Material.fromType("Color");m.uniforms.color=new Cesium.Color(c[0],c[1],c[2],a);const g=new Cesium.GeometryInstance({geometry:d,attributes:{color:Cesium.ColorGeometryInstanceAttribute.fromColor(new Cesium.Color(c[0],c[1],c[2],a))}}),f=new Cesium.Primitive({geometryInstances:g,appearance:new Cesium.MaterialAppearance({material:m,translucentPasses:!0,closed:!0}),asynchronous:!1});n.primitives.add(f),this._entityPrimitives.push(f)}_addBoundingBox(e,t){const i=this.viewer.getScene(),n=e.min,s=e.max,r=Cesium.Cartesian3.fromDegrees(n[0],n[1],n[2]),o=Cesium.Cartesian3.fromDegrees(s[0],s[1],s[2]),h=[new Cesium.Cartesian3(r.x,r.y,r.z),new Cesium.Cartesian3(o.x,r.y,r.z),new Cesium.Cartesian3(o.x,o.y,r.z),new Cesium.Cartesian3(r.x,o.y,r.z),new Cesium.Cartesian3(r.x,r.y,o.z),new Cesium.Cartesian3(o.x,r.y,o.z),new Cesium.Cartesian3(o.x,o.y,o.z),new Cesium.Cartesian3(r.x,o.y,o.z)],c=[];for(const f of h)c.push(f.x,f.y,f.z);const a=[0,1,1,2,2,3,3,0,4,5,5,6,6,7,7,4,0,4,1,5,2,6,3,7],d=new Cesium.Geometry({attributes:{position:new Cesium.GeometryAttribute({componentDatatype:Cesium.ComponentDatatype.DOUBLE,componentsPerAttribute:3,values:new Float64Array(c)})},indices:new Uint16Array(a),primitiveType:Cesium.PrimitiveType.LINES}),m=new Cesium.GeometryInstance({geometry:d,attributes:{color:Cesium.ColorGeometryInstanceAttribute.fromColor(new Cesium.Color(t[0],t[1],t[2],1))}}),g=new Cesium.Primitive({geometryInstances:m,appearance:new Cesium.PolylineColorAppearance,asynchronous:!1});i.primitives.add(g),this._boundingBoxPrimitives.push(g)}highlightEntity(e){this._highlightedIndex=e,this._entities.length>0&&this.visualize(this._entities)}clear(){const e=this.viewer.getScene();for(const t of this._entityPrimitives)e.primitives.remove(t);this._entityPrimitives=[];for(const t of this._boundingBoxPrimitives)e.primitives.remove(t);this._boundingBoxPrimitives=[],this._entities=[],this._highlightedIndex=-1}exportGeoJSON(e){const t=[];for(const n of e){const s=n.boundingBox,r=[[s.min[0],s.min[1]],[s.max[0],s.min[1]],[s.max[0],s.max[1]],[s.min[0],s.max[1]],[s.min[0],s.min[1]]];t.push({type:"Feature",geometry:{type:"Polygon",coordinates:[r]},properties:{entityId:n.id,area:n.area,faceCount:n.faces.length,center:n.center}})}const i={type:"FeatureCollection",features:t};this._downloadJSON(i,"entities_bounding_box.geojson")}exportSpatialJSON(e){const t=e.map(i=>({id:i.id,boundingBox:i.boundingBox,area:i.area,faceCount:i.faces.length,center:i.center,minHeight:i.boundingBox.min[2],maxHeight:i.boundingBox.max[2]}));this._downloadJSON(t,"entities_spatial_params.json")}exportGLB(e){!e||e.length===0||this._exportOBJ(e)}_exportOBJ(e){let t=[],i=1;t.push("# 3D Entity Segmentation Export"),t.push("# Generated by EntityVisualizer"),t.push("");for(let r=0;r<e.length;r++){const o=e[r];t.push(`o Entity_${r}_${o.id}`);for(const h of o.faces)for(const c of h.vertices)t.push(`v ${c.x.toFixed(6)} ${c.y.toFixed(6)} ${c.z.toFixed(6)}`);for(const h of o.faces)t.push(`f ${i} ${i+1} ${i+2}`),i+=3;t.push("")}const n=t.join(`
`),s=new Blob([n],{type:"text/plain"});this._downloadBlob(s,"entities_model.obj")}_downloadJSON(e,t){const i=JSON.stringify(e,null,2),n=new Blob([i],{type:"application/json"});this._downloadBlob(n,t)}_downloadBlob(e,t){const i=URL.createObjectURL(e),n=document.createElement("a");n.href=i,n.download=t,document.body.appendChild(n),n.click(),document.body.removeChild(n),URL.revokeObjectURL(i)}destroy(){this.clear()}}class ve{constructor(e){this.viewer=e,this._rectMode=!1,this._startPoint=null,this._endPoint=null,this._rectCanvas=null,this._rectCtx=null,this._onRectSelectCallback=null,this._handler=null,this._pickHandler=null,this._resizeHandler=null,this._keyHandler=null,this._initRectCanvas(),this._initHandlers()}_initRectCanvas(){const e=this.viewer.containerId,t=document.getElementById(e);this._rectCanvas=document.getElementById("rectCanvas"),this._rectCanvas||(this._rectCanvas=document.createElement("canvas"),this._rectCanvas.id="rectCanvas",this._rectCanvas.style.position="absolute",this._rectCanvas.style.top="0",this._rectCanvas.style.left="0",this._rectCanvas.style.cursor="crosshair",this._rectCanvas.style.display="none",this._rectCanvas.style.zIndex="10",this._rectCanvas.style.pointerEvents="auto",t?(t.style.position=t.style.position||"relative",t.appendChild(this._rectCanvas)):document.body.appendChild(this._rectCanvas)),this._rectCtx=this._rectCanvas.getContext("2d")}_initHandlers(){this._handler=new Cesium.ScreenSpaceEventHandler(this._rectCanvas),this._handler.setInputAction(e=>{this._rectMode&&(this._startPoint={x:e.endPosition.x,y:e.endPosition.y},this._endPoint=null,this._clearRect())},Cesium.ScreenSpaceEventType.LEFT_DOWN),this._handler.setInputAction(e=>{!this._rectMode||!this._startPoint||(this._endPoint={x:e.endPosition.x,y:e.endPosition.y},this._drawRect())},Cesium.ScreenSpaceEventType.MOUSE_MOVE),this._handler.setInputAction(()=>{if(!this._rectMode)return;if(!this._startPoint||!this._endPoint){this._cancelRect();return}const e=this._getNormalizedRect();this._clearRect(),this._startPoint=null,this._endPoint=null,this._onRectSelectCallback&&e&&this._onRectSelectCallback(e),this._rectMode=!1,this._rectCanvas.style.display="none"},Cesium.ScreenSpaceEventType.LEFT_UP),this._handler.setInputAction(()=>{this._rectMode&&this._cancelRect()},Cesium.ScreenSpaceEventType.RIGHT_DOWN),this._resizeHandler=()=>this._updateCanvasSize(),window.addEventListener("resize",this._resizeHandler),this._keyHandler=e=>{e.key==="Escape"&&this._rectMode&&this._cancelRect()},window.addEventListener("keydown",this._keyHandler)}_updateCanvasSize(){if(!this._rectCanvas)return;const e=this.viewer.containerId,t=document.getElementById(e),i=this.viewer.getCanvas();if(t){const n=t.getBoundingClientRect();this._rectCanvas.width=i.width,this._rectCanvas.height=i.height,this._rectCanvas.style.width=n.width+"px",this._rectCanvas.style.height=n.height+"px"}else this._rectCanvas.width=i.width,this._rectCanvas.height=i.height}setRectMode(e){this._rectMode=e,e?(this._updateCanvasSize(),this._rectCanvas.style.display="block",this._startPoint=null,this._endPoint=null,this._clearRect()):(this._rectCanvas.style.display="none",this._clearRect(),this._startPoint=null,this._endPoint=null)}onRectSelect(e){this._onRectSelectCallback=e}_drawRect(){if(!this._startPoint||!this._endPoint)return;const e=this._rectCtx;e.clearRect(0,0,this._rectCanvas.width,this._rectCanvas.height);const t=Math.min(this._startPoint.x,this._endPoint.x),i=Math.min(this._startPoint.y,this._endPoint.y),n=Math.abs(this._endPoint.x-this._startPoint.x),s=Math.abs(this._endPoint.y-this._startPoint.y);e.fillStyle="rgba(79, 195, 247, 0.2)",e.fillRect(t,i,n,s),e.strokeStyle="#4fc3f7",e.lineWidth=2,e.strokeRect(t,i,n,s)}_clearRect(){this._rectCtx&&this._rectCtx.clearRect(0,0,this._rectCanvas.width,this._rectCanvas.height)}_cancelRect(){this._clearRect(),this._startPoint=null,this._endPoint=null,this._rectMode=!1,this._rectCanvas.style.display="none"}_getNormalizedRect(){if(!this._startPoint||!this._endPoint)return null;const e=Math.min(this._startPoint.x,this._endPoint.x),t=Math.min(this._startPoint.y,this._endPoint.y),i=Math.abs(this._endPoint.x-this._startPoint.x),n=Math.abs(this._endPoint.y-this._startPoint.y);if(i<5||n<5)return null;const s=this.viewer.getCanvas();return{x:e/s.width,y:t/s.height,width:i/s.width,height:n/s.height,pixelRect:{x:e,y:t,width:i,height:n}}}getScreenRect(){return this._getNormalizedRect()}screenToWorld(e,t){const i=this.viewer.viewer,n=i.camera.getPickRay(new Cesium.Cartesian2(e,t));return n?i.scene.globe.pick(n,i.scene.globe.ellipsoid):null}onEntityClick(e){this.removeEntityClickHandler(),this._pickHandler=new Cesium.ScreenSpaceEventHandler(this.viewer.viewer.scene.canvas),this._pickHandler.setInputAction(t=>{if(this._rectMode)return;const i=this.viewer.viewer.scene.pick(t.position);i&&i.primitive&&e(i)},Cesium.ScreenSpaceEventType.LEFT_CLICK)}removeEntityClickHandler(){this._pickHandler&&(this._pickHandler.destroy(),this._pickHandler=null)}getCurrentViewBounds(){const t=this.viewer.viewer.camera.computeViewRectangle();return t?{west:Cesium.Math.toDegrees(t.west),east:Cesium.Math.toDegrees(t.east),south:Cesium.Math.toDegrees(t.south),north:Cesium.Math.toDegrees(t.north)}:null}destroy(){this.setRectMode(!1),this._handler&&(this._handler.destroy(),this._handler=null),this.removeEntityClickHandler(),this._resizeHandler&&(window.removeEventListener("resize",this._resizeHandler),this._resizeHandler=null),this._keyHandler&&(window.removeEventListener("keydown",this._keyHandler),this._keyHandler=null),this._rectCanvas&&this._rectCanvas.parentNode&&this._rectCanvas.parentNode.removeChild(this._rectCanvas),this._rectCanvas=null,this._rectCtx=null}}function _e(){return new Promise((l,e)=>{if(window.Cesium){l();return}const t=document.createElement("script");t.src="./cesium/Cesium.js",t.onload=()=>{window.Cesium?l():e(new Error("Cesium failed to load"))},t.onerror=()=>e(new Error("Cesium script load failed")),document.head.appendChild(t)})}const u={viewer:null,tileLoader:null,multiViewRenderer:null,segmentEngine:null,backProjector:null,spatialCluster:null,entityVisualizer:null,interactionController:null,entities:[],extractMode:"viewport",config:{views:["top","angle","front"],connectThreshold:.5,minFaces:20,filterGround:!0,groundThreshold:.1}},C=l=>document.getElementById(l);function I(l){const e=C("loadingOverlay");e.style.display="block",C("loadingText").textContent=l||"处理中..."}function E(){C("loadingOverlay").style.display="none"}function y(l){C("statusText").textContent=l}async function xe(){I("加载 Cesium 引擎..."),y("加载 Cesium 引擎...");try{await _e(),console.log("Cesium loaded:",typeof Cesium)}catch(l){console.error("Cesium load failed:",l),E(),y("Cesium 加载失败: "+l.message);return}I("初始化三维引擎..."),y("初始化中...");try{u.viewer=new de("cesiumContainer"),u.tileLoader=new me(u.viewer),u.multiViewRenderer=new fe(u.viewer),u.segmentEngine=new Ce,u.backProjector=new we(u.viewer),u.spatialCluster=new pe,u.entityVisualizer=new ye(u.viewer),u.interactionController=new ve(u.viewer),u.viewer.onTileCountChange(l=>C("tileCount").textContent=l),u.viewer.onFPSUpdate(l=>C("fpsCounter").textContent=l.toFixed(0)),u.interactionController.onRectSelect(async l=>{I("框选区域提取中..."),y("框选提取中..."),await Q(l),E()}),u.interactionController.onEntityClick(l=>{const e=u.entityVisualizer._entityPrimitives.indexOf(l.primitive);if(e>=0){const t=Math.floor(e/2);W(t)}}),E(),y("就绪 - 请加载瓦片数据"),be(),$("viewport")}catch(l){console.error("初始化失败:",l),E(),y("初始化失败: "+l.message)}}function be(){C("loadTilesBtn").addEventListener("click",Me),C("flyHomeBtn").addEventListener("click",()=>u.viewer.flyHome()),C("extractBtn").addEventListener("click",Te),C("clearBtn").addEventListener("click",Ee),C("modeViewportBtn").addEventListener("click",()=>$("viewport")),C("modeRectBtn").addEventListener("click",()=>$("rect")),document.querySelectorAll(".view-badge").forEach(l=>{l.addEventListener("click",()=>{const e=l.dataset.view;u.config.views.includes(e)?(u.config.views=u.config.views.filter(t=>t!==e),l.classList.remove("active")):(u.config.views.push(e),l.classList.add("active"))})}),C("threshold").addEventListener("input",l=>{u.config.connectThreshold=parseFloat(l.target.value),C("thresholdVal").textContent=l.target.value}),C("minFaces").addEventListener("input",l=>{u.config.minFaces=parseInt(l.target.value),C("minFacesVal").textContent=l.target.value}),C("filterGround").addEventListener("change",l=>{u.config.filterGround=l.target.checked}),C("exportGeoJSON").addEventListener("click",()=>{u.entities.length>0&&u.entityVisualizer.exportGeoJSON(u.entities)}),C("exportJSON").addEventListener("click",()=>{u.entities.length>0&&u.entityVisualizer.exportSpatialJSON(u.entities)})}function $(l){u.extractMode=l,C("modeViewportBtn").classList.toggle("active",l==="viewport"),C("modeRectBtn").classList.toggle("active",l==="rect"),u.interactionController.setRectMode(l==="rect"),y(l==="rect"?"请在场景中框选区域...":'就绪 - 点击"开始提取"进行全视口提取')}async function Me(){const l=C("tilesetUrl").value.trim();if(l){I("加载瓦片数据..."),y("加载瓦片中...");try{await u.tileLoader.load(l),y("瓦片加载完成 - 可开始实体提取"),C("extractBtn").disabled=!1}catch(e){console.error("瓦片加载失败:",e),y("瓦片加载失败: "+e.message)}finally{E()}}}async function Te(){u.extractMode==="viewport"?(I("全视口实体提取中..."),y("全视口提取中..."),await Q(null),E()):(y("请在场景中框选区域..."),u.interactionController.setRectMode(!0))}async function Q(l){const e=performance.now();try{const i=u.config.views.map(a=>l?u.multiViewRenderer.getViewWithRect(a,l):u.multiViewRenderer.getView(a));y("多视角渲染采样...");const n=await u.multiViewRenderer.renderViews(i);y("AI模型分割推理...");const s=await u.segmentEngine.segmentMultiView(n);y("掩码融合与三维反投影...");const r=u.tileLoader.getVisibleTriangles(),o=u.backProjector.projectTo3D(n,s,r);y("空间连通聚类...");const h=u.spatialCluster.cluster(o,{connectThreshold:u.config.connectThreshold,minFaces:u.config.minFaces,filterGround:u.config.filterGround,groundThreshold:u.config.groundThreshold});y("实体可视化..."),u.entityVisualizer.visualize(h),u.interactionController.onEntityClick(a=>{const d=u.entityVisualizer._entityPrimitives.indexOf(a.primitive);if(d>=0){const m=Math.floor(d/2);W(m)}}),u.entities=h;const c=((performance.now()-e)/1e3).toFixed(2);Se(h,c),C("entityCountStatus").textContent=h.length,y(`提取完成 - ${h.length} 个实体, 耗时 ${c}s`),C("resultPanel").classList.remove("hidden")}catch(t){console.error("提取失败:",t),y("提取失败: "+t.message)}}function W(l){l<0||l>=u.entities.length||(u.entityVisualizer.highlightEntity(l),u.viewer.flyToEntity(u.entities[l]),document.querySelectorAll(".entity-item").forEach(e=>{e.classList.toggle("selected",parseInt(e.dataset.entityId)===l)}))}function Se(l,e){C("entityCount").textContent=l.length,C("processTime").textContent=e+"s";const t=C("entityList");t.innerHTML="",l.forEach((i,n)=>{const s=document.createElement("div");s.className="entity-item",s.dataset.entityId=n;const r=i.boundingBox.center,o=i.area.toFixed(1),h=i.faces.length;s.innerHTML=`
    ...
    `,s.addEventListener("click",()=>W(n)),t.appendChild(s)})}function Ee(){u.entities=[],u.entityVisualizer.clear(),u.segmentEngine.clear(),C("resultPanel").classList.add("hidden"),C("entityCountStatus").textContent="0",y("已清除")}xe();
